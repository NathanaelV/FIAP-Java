...
import br.com.challenge.model.dao.*;
import br.com.challenge.model.dto.*;
...
//                            email = "meu@email.com";
                        ...
                        System.out.println(contatoDAO.inserir(contato));

                        // Salvar o ID do Contato
                        ArrayList<Contato> listaContato = contatoDAO.listarTodos();
                        int ultimoId = listaContato.size() - 1;
                        contato.setId(listaContato.get(ultimoId).getId());
...
//                            cep = "01538001";
                        ...
                        // Salvar o ID do endereço
                        ArrayList<Endereco> listaEndereco = enderecoDAO.listarTodos();
                        ultimoId = listaEndereco.size() - 1;
                        endereco.setId(listaEndereco.get(ultimoId).getId());
...
//                            tipoDePlano = "Básico";
                        ...
                        RedeCredenciadaDAO redeCredenciadaDAO = new RedeCredenciadaDAO(con);
                        System.out.println(redeCredenciadaDAO.inserir(redeCredenciada));

                        // Salvar o ID do Rede Credenciada
                        ArrayList<RedeCredenciada> listaRedeCredenciada = redeCredenciadaDAO.listarTodos();
                        ultimoId = listaRedeCredenciada.size() - 1;
                        redeCredenciada.setId(listaRedeCredenciada.get(ultimoId).getId());
...
//                                email = "acompanhante@email.com";
                            ...
                            // Definir ID do Contato do Acompanhante
                            System.out.println(contatoDAO.inserir(contatoAcompanhante));

                            listaContato = contatoDAO.listarTodos();
                            ultimoId = listaContato.size() - 1;
                            contatoAcompanhante.setId(listaContato.get(ultimoId).getId());
...
//                                parentesco = "Irmão";
                            ...
                            System.out.println(acompanhanteDAO.inserir(acompanhante));

                            ArrayList<Acompanhante> listaAcompanhante = acompanhanteDAO.listarTodos();
                            ultimoId = listaContato.size() - 1;
                            contatoAcompanhante.setId(listaContato.get(ultimoId).getId());
...
//                                                dataStr = "25/11/2030";
                    ...
                    // Logar Paciente:
                    case 2:
                        // Verifica se to paciente existe
